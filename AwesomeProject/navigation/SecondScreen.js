    ...
    return(
      ...
      <View style={{flexDirection:'row',width:'70%',marginLeft:65}}>
        <TouchableOpacity style={[styles.btn]}>
          <Text style={[styles.btnText]}  onPress={()=> navigation.navigate('signup')}>Type in your code</Text>
          <Text style={[styles.text3]}  onPress={()=> navigation.navigate('signup')}>Not registered yet? Click here</Text>
        </TouchableOpacity>
      </View>
      </View>
    )
